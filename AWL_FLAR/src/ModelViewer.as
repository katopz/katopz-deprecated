package
{
	...
	public class ModelViewer
	{
		...
		public function ModelViewer(scene:Scene3D)
		{
			...
			_root.x = FLARConfig.POSITION_X;
			_root.y = FLARConfig.POSITION_Y;
			_root.x = FLARConfig.POSITION_Z;
			
			_root.rotationX = FLARConfig.ROTATION_X;
			_root.rotationY = FLARConfig.ROTATION_Y;
			_root.rotationZ = FLARConfig.ROTATION_Z;
			
			_root.scaleX = FLARConfig.SCALE_X;
			_root.scaleY = FLARConfig.SCALE_Y;
			_root.scaleZ = FLARConfig.SCALE_Z;
		}
		...
		private function onSuccess(event:Loader3DEvent):void
		{
			...
			*/
			/*
			_model.rotationX = FLARConfig.ROTATION_X+90;
			_model.rotationY = FLARConfig.ROTATION_Y;
			_model.rotationZ = FLARConfig.ROTATION_Z+90;
			*/
			try{
		...
		*/
		...
		public function setAxis(_FLARResult:FLARResult):void
		{
			...
			_base.transform.matrix3D.interpolateTo(_temp.transform.matrix3D, FLARConfig.MATRIX3D_INTERPOLATE);
			/*
			if(!_default)
			{
