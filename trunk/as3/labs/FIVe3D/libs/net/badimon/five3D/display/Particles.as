...
package net.badimon.five3D.display {
	 ...
	 */
	public class Particles extends Bitmap implements IObject3D {
		 ...
		 */
		public function Particles(bitmapData:BitmapData = null, smoothing:Boolean = true, subdivisionsHorizontal:int = 3, subdivisionsVertical:int = 3) {
		...
		private function drawBitmap():void {
			...
			while (--len > -1) {
				...
				if(clipRect.containsRect(_rect))
				{
					...
					*/
					bitmapData.setPixel(xp1, yp1, 0xFF0000);
				}
			}
		}
