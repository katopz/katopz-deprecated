package  
{
	...
	{
		private const MAX_PARTICLES: int = 700;//0x400;
		...
		private function onEnterFrame( event: Event ): void
		{
			...
			*/
			...
			for each(var _particle:Particle in particles)
			{
				...
				bmp.bitmapData.copyPixels(tmp_bmp, tmp_bmp.rect, new Point(_particle.screenX, _particle.screenY), null, null, true);
			}
