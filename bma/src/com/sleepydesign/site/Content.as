	...
	public class Content extends Sprite{
		...
		*/
		...
		public function hide(time:Number=0.5) {
			Tweener.addTween(this, {onComplete:function(){this.visible = false}, alpha:0, time:time, delay:0,transition:"easeoutquad"});
		}
		
		public function show(time:Number=0.5) {
			Tweener.addTween(this, {onStart:function(){this.visible = true}, alpha:1, time:time, delay:0,transition:"easeoutquad"});
		}
	}
