...
package {
	...
	public class Water extends Sprite{
		...
		public function Water(iRect:Rectangle=null,alpha:Number=0.1,iRotation:Number=180, color1:Number=0x0033FF, color2:Number=0x0033FF, color3:Number=0x0099FF){
			
			if(iRect){
				var fillType:String = GradientType.LINEAR;
				var colors:Array = [color2, color3];
				...
				graphics.lineStyle(0.5,color1,0.5)
