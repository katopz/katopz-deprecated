package
{
	...
	public class shell extends Panel
	{
		...
		public function createPanel(iPanel:Panel):void
		{
			...
			var panelConfig = StringUtil.getNodeById(config, panelId);
			...
			var mapConfig = StringUtil.getNodeById(config, mapId);
			...
			var graphConfig = StringUtil.getNodeById(config, graphId);
			...
			var stationConfig = StringUtil.getNodeById(config, stationId);
		...
		public function onPanelSetFocus(event:ContentEvent):void
		{
			...
			{
				getList(StringUtil.getNodeById(page.config, page.name + "List").@src);
			}
		}
		...
		private function linkClick(event:MouseEvent):void
		{
			...
			var link = StringUtil.getNodeById(config, target.name);
