package org.papervision3d.objects.parsers {
	 ...
	 */
	public class MD2 extends TriangleMesh3D implements IAnimationDataProvider, IAnimatable, IClip3D
	{
		/**
		...
		protected function readFrames(data:ByteArray):void
		{
			...
			{				
				...
				for (j = 0; j < num_vertices; j++, data.position++)
				{
					...
					v.x = -v.x;
					//var v2:Vertex3D = new Vertex3D(v.y, v.z, v.x);
