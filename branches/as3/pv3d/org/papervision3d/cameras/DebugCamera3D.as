package org.papervision3d.cameras
{
	...
	public class DebugCamera3D extends Camera3D
	{
		...
		public function DebugCamera3D(viewport3D:Viewport3D, fovY:Number = 90, near:Number = 10, far:Number = 5000) 
		{
			...
			this.focus = (this.viewport.height*.5) / Math.tan((fovY*.5) * (Math.PI/180));
		...
		{
			targetRotationY = startRotationY - (startPoint.x - viewportStage.mouseX)*.5;
			targetRotationX = startRotationX + (startPoint.y - viewportStage.mouseY)*.5;
		}
