...
package com.yahoo.astra.fl.charts
{
	...
	/**
	 * If an axis has major or minor units, and snapToUnits is true, the labels,
	 * ticks, gridlines, and other objects will snap to the nearest major or minor
	 * unit respectively.
	 * 
	 * @default true
	 */
	[Style(name="snapToUnits", type="Boolean")]
	...
	//--------------------------------------
		 ...
		 * 
		 * @see com.yahoo.charts.AxisOrientation
		 */
		 ...
		 * By default, vertical axes draw objects from top to bottom, and horizontal
		 ...
		 * 
		 * @see com.yahoo.charts.IPlotArea
		 */
	...
	//--------------------------------------
		 ...
		 */
		function updateScale(data:Array):Array;
