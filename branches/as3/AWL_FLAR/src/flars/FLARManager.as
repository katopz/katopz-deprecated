package flars
{
	...
	public class FLARManager
	{
		...
		[Embed(source='marker32.pat',mimeType='application/octet-stream')]
		...
		public function FLARManager(container:DisplayObjectContainer, bitmapData:BitmapData)
		{
			...
			code = new FLARCode(32, 32, 100, 100);
		...
		public function getAxis():FLARResult
		{
			var _r:FLARMultiMarkerDetectorResult = detector.getResult(0);
			
			var r:FLARResult = new FLARResult();
			r.confidence = detector.getConfidence(0);
			detector.getTransmationMatrix(0, r.result);
			r.square = detector.getResult(0).square;
