package com.cutecoma.engine3d.api.texture
{
    ...
    public class TexturePool extends Texture
    {
        ...
        public function TexturePool(... args)
        {
            ...
            var _loc_3:int = 0;
            var _loc_4:* = new BitmapData(this._SampleSize * _loc_2.length, this._SampleSize);
        ...
        protected function onComplete(event:Event) : void
        {
            ...
            var _loc_4:* = this._SampleSize / _loc_3.width;
            var _loc_5:* = this._SampleSize / _loc_3.height;
            var _loc_6:* = new Matrix();
            new Matrix().scale(_loc_4, _loc_5);
            _loc_6.translate(this._Order[_loc_2.loader] * this._SampleSize, 0);
