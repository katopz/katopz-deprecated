﻿package
{
	...
	public class main extends SDApplication
	{
		...
		override public function create(config:Object=null):void
		{
			...
			chars.addCharacter(new CharacterData
			(
				"man1", "assets/man1/model.dae", 1, 100, 24,
				["stand", "walk", "sit"]
			));
			
			chars.addCharacter(new CharacterData
			(
				"woman1", "assets/woman1/model.dae", 1, 100, 24,
				["stand", "walk", "sit"]
			));
			
			chars.addCharacter(new CharacterData
			(
				"man2", "assets/man2/model.dae", 1, 100, 24,
				["stand", "walk", "sit"]
			));
			
			chars.addCharacter(new CharacterData
			(
				"woman2", "assets/woman2/model.dae", 1, 100, 24,
				["stand", "walk", "sit"]
			));
