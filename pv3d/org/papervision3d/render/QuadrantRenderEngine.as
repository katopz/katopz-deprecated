package org.papervision3d.render
{
	...
	public class QuadrantRenderEngine extends BasicRenderEngine implements IRenderEngine
	{
		...
		protected override function doRender(renderSessionData:RenderSessionData, layers:Array = null):RenderStatistics
		{
			...
			clip = new RectangleClipping(-renderSessionData.viewPort.viewportWidth*.5, -renderSessionData.viewPort.viewportHeight*.5, renderSessionData.viewPort.viewportWidth*.5, renderSessionData.viewPort.viewportHeight*.5);//new Clipping();
