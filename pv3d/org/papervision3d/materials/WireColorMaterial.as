...
*
*/
public class WireColorMaterial extends TriangleMaterial implements ITriangleDrawer
{
	...
	*/
	public function WireColorMaterial( color:Number=0xFF00FF, alpha:Number = 1, interactive:Boolean = false, lineColor:Number=0xFF00FF)
	{
	...
	override public function drawTriangle(tri:RenderTriangle, graphics:Graphics, renderSessionData:RenderSessionData, altBitmap:BitmapData=null, altUV:Matrix=null):void{
		...
		graphics.lineStyle( 1, lineColor, 1, false, "none" );
