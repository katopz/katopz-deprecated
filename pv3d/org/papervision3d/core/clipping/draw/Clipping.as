        ...
        public function screen(container:Sprite):Clipping
        {
        	...
        	switch(container.stage.align)
        	{
	            ...
	            case StageAlign.BOTTOM_RIGHT:
	                ...
	                break;
	            case StageAlign.TOP:
	            	zeroPoint.x = container.stage.stageWidth*.5;
	            	zeroPoint.y = 0;
	                globalPoint = container.globalToLocal(zeroPoint);
	                
	                rectangleClipping.minX = globalPoint.x - container.stage.stageWidth*.5;
	                rectangleClipping.maxX = globalPoint.x + container.stage.stageWidth*.5;
	                rectangleClipping.maxY = (rectangleClipping.minY = globalPoint.y) + container.stage.stageHeight;
	                break;
	            ...
	            case StageAlign.LEFT:
	            	zeroPoint.x = 0;
	            	zeroPoint.y = container.stage.stageHeight*.5;
	                globalPoint = container.globalToLocal(zeroPoint);
	                
	                rectangleClipping.maxX = (rectangleClipping.minX = globalPoint.x) + container.stage.stageWidth;
	                rectangleClipping.minY = globalPoint.y - container.stage.stageHeight*.5;
	                rectangleClipping.maxY = globalPoint.y + container.stage.stageHeight*.5;
	                break;
