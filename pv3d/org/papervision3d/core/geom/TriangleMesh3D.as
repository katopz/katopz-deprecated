		...
		*/
		...
		public function quarterFaces():void
		{
			...
			while( face = faces[--i] )
			{
				...
				var v01:Vertex3D = new Vertex3D((v0.x+v1.x)*.5, (v0.y+v1.y)*.5, (v0.z+v1.z)*.5);
				var v12:Vertex3D = new Vertex3D((v1.x+v2.x)*.5, (v1.y+v2.y)*.5, (v1.z+v2.z)*.5);
				var v20:Vertex3D = new Vertex3D((v2.x+v0.x)*.5, (v2.y+v0.y)*.5, (v2.z+v0.z)*.5);
				...
				var t01:NumberUV = new NumberUV((t0.u+t1.u)*.5, (t0.v+t1.v)*.5);
				var t12:NumberUV = new NumberUV((t1.u+t2.u)*.5, (t1.v+t2.v)*.5);
				var t20:NumberUV = new NumberUV((t2.u+t0.u)*.5, (t2.v+t0.v)*.5);
