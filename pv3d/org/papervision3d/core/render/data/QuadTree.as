    ...
    */
    public final class QuadTree
    {
		...
		public function set clip(val:Clipping):void
		{
			...
			if (!_root)
				_root = new QuadTreeNode((_rect.minX + _rect.maxX)*.5, (_rect.minY + _rect.maxY)*.5, _rect.maxX - _rect.minX, _rect.maxY - _rect.minY, 0, null, _maxlevel);
			else
				_root.reset((_rect.minX + _rect.maxX)*.5, (_rect.minY + _rect.maxY)*.5, _rect.maxX - _rect.minX, _rect.maxY - _rect.minY, _maxlevel);	
		}
